...
import { DomainSettingsModal } from '@/components/dashboard/domain-settings-modal';
...
export default function DashboardPage() {
  ...
  const [domainSettingsWebsite, setDomainSettingsWebsite] = useState<{
    id: string;
    subdomain: string;
  } | null>(null);
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
                ...
                <Card className="h-48 transition-shadow hover:shadow-md">
                  <CardContent className="flex h-full flex-col justify-between p-6">
                    ...
                    <div className="flex items-center justify-between">
                      {website.published ? (
                        <a
                          href={`http://${website.subdomain}.${process.env.NEXT_PUBLIC_ROOT_DOMAIN ?? 'aibuilder.dev'}`}
                          target="_blank"
                      ...
                      <div className="flex gap-2">
                        ...
                        >
                          {exporting === website.id ? 'Exporting...' : 'Export'}
                        </Button>
      ...
      {domainSettingsWebsite && (
        <DomainSettingsModal
          isOpen={!!domainSettingsWebsite}
          onClose={() => setDomainSettingsWebsite(null)}
          websiteId={domainSettingsWebsite.id}
          subdomain={domainSettingsWebsite.subdomain}
        />
      )}
    </div>
  );
