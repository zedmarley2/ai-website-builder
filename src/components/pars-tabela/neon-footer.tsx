...
const NAV_LINKS = [
  { label: 'Ana Sayfa', href: '/pars-tabela' },
  { label: 'Hizmetlerimiz', href: '/pars-tabela#hizmetlerimiz' },
  { label: 'Ürünlerimiz', href: '/pars-tabela#urunlerimiz' },
  { label: 'Hakkımızda', href: '/pars-tabela#hakkimizda' },
  { label: 'İletişim', href: '/pars-tabela#iletisim' },
];

const SERVICE_LINKS = [
  { label: 'Neon Tabela', href: '/pars-tabela#hizmetlerimiz' },
  { label: 'LED Tabela', href: '/pars-tabela#hizmetlerimiz' },
  { label: 'Elektronik Tabela', href: '/pars-tabela#hizmetlerimiz' },
  { label: 'Kutu Harf', href: '/pars-tabela#hizmetlerimiz' },
];
