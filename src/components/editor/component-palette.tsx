  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          fillRule="evenodd"
          d="M4 3a1 1 0 00-1 1v1a1 1 0 002 0V4h5v12H8a1 1 0 100 2h4a1 1 0 100-2h-2V4h5v1a1 1 0 102 0V4a1 1 0 00-1-1H4z"
          clipRule="evenodd"
        />
      </svg>
    ),
      ...
      <div className="flex-1 overflow-y-auto p-3">
        <div className="space-y-1.5">
          {componentTypes.map((component, index) => (
            ...
            >
              <span className="text-gray-400 dark:text-gray-500">{component.icon}</span>
              {component.label}
            </motion.button>
          ))}
        </div>
